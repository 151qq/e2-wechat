<template>
  <!--消息列表组件 数据交互频繁-->
    ...
    <li :class="{'item-hide':deleteMsg}">
        ...
        <router-link :to="{ path: '/iframe', query: { mid: item.mid,name:item.group_name||(item.user[0].remark||item.user[0].nickname),group_num:item.user.length}}" tag="div" class="list-info" v-swiper v-on:click.native="toggleMsgRead($event,'enter')">
          <div class="header-box">
            ...
            <div class="desc-box">
                ...
                <div class="desc-msg">
                    <div class="desc-mute iconfont " v-show="item.quiet">
                    </div>
