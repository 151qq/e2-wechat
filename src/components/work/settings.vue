<template>
    ...
    <div class="setting">
        <header id="wx-header">
            <div class="center">
                <router-link to="/work" tag="div" class="iconfont icon-return-arrow">
                    <span>我</span>
                </router-link>
                <span>设置</span>
            </div>
        ...
        <section>
            <div class="weui-cells">
                <router-link to="/work/settings/security" class="weui-cell weui-cell_access">
                    <div class="weui-cell__bd">帐号与安全</div>
                    <div class="weui-cell__ft">已保护</div>
                </router-link>
            </div>
            <div class="weui-cells">
                <router-link to="/work/settings/notice" class="weui-cell weui-cell_access">
                    <div class="weui-cell__bd">新消息通知</div>
                    <div class="weui-cell__ft"></div>
                </router-link>
                <router-link to="/work/settings/privacy" class="weui-cell weui-cell_access">
                    <div class="weui-cell__bd">隐私</div>
                    <div class="weui-cell__ft"></div>
                </router-link>
                <router-link to="/work/settings/common" class="weui-cell weui-cell_access">
