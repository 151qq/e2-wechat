<template>
    <div class="notice">
        <header id="wx-header">
            ...
            <div class="center">
                <router-link to="/work/settings" tag="div" class="iconfont icon-return-arrow">
                    <span>设置</span>
                </router-link>
                <span>新消息通知</span>
            </div>
        ...
        <section>
            ...
            <div class="weui-cells__tips">如果你要关闭或开启微信的新消息通知,请在 iPhone 的"设置"——"通知"功能中, 找到应用程序"vue-wechat"更改.</div>
            <div class="weui-cells">
