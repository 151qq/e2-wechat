...
export default {
    ...
    mounted () {
        this.getList()
        if (!this.$route.query.isPage && this.attachmentData.targetType  && this.attachmentData.targetType == 'attachmen_type_8') {
        ...
        if (this.$route.query.isPage && this.attachmentPage.targetType  && this.attachmentPage.targetType == 'attachmen_type_8') {
    ...
    methods: {
        ...
        addAttachment (item) {
            ...
            if (index > -1) {
                ...
                this.attachmentCodes.push(item.couponGroupCode)
